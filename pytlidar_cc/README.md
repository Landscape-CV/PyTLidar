...
CloudCompare's Python console `import pytlidar_cc` will fail. Rerun the
install with that environment's own python (on Windows, the python.exe
inside the CloudCompare folder).
